...
<body>
    ...
    // init configuration
    $clientID = '1096493319134-leofvgrmhjvj5n74b61p0bahip1au1ta.apps.googleusercontent.com'; // your client id
    $clientSecret = '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'; // your client secret
    $redirectUri = 'https://urbanwear.com/';
                ...
                <nav class="header__nav-wrap">
                    <ul class="header__nav">
                        ...
                        <li class="has-children">
                            ...
                            <ul class="sub-menu">
                                <li><a for="email"><?php echo $email; ?></a></li>
                        </li>
                    <?php
                } else {
                    ?>
                        <li><a href="<?php echo $client->createAuthUrl() ?>">Login with Google</a></li>
                    <?php
                }
                    ?>
                    </ul>
